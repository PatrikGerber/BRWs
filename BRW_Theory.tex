...
% and $F(t) \defeq \frac{\widehat{\psi}(t)}{t}$
% In his proof he uses the following lemma:
% \begin{lemma}[{{\cite[Lema A.1]{jaffuel2227critical}}}]
% If there exists no $t^* \in (0, \zeta)$ satisfying (\ref{eqn:t*exists}) then $F: (0, \zeta) \to \R$ is nonde
% \end{lemma}
